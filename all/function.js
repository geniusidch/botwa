...
exports.getRandom2 = (ext) => {
    return `${Math.floor(Math.random() * 2)}${ext}`
}
...
exports.ucapan = () => {
  ...
  if (currentHour >= 5 && currentHour < 12) {
    greeting = 'Pagi Para Staff Genius 🌅'
  } else if (currentHour >= 12 && currentHour < 15) {
    greeting = 'Siang Para Staff Genius 🌇'
  } else if (currentHour >= 15 && currentHour < 18) {
    greeting = 'Sore Para Staff Genius 🌄'
  } else {
    greeting = 'Malam Para Staff Genius 🌃'
  }
  return greeting
}
